    ...
    <>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="mx-auto max-w-3xl space-y-6">
          <h1 className="text-5xl font-bold tracking-tight sm:text-6xl animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex justify-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            <Link href="/sign-up">
      ...
      <section className="bg-muted/30 py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="space-y-3 rounded-lg border bg-card p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300">
              <Music className="h-10 w-10 text-purple-600 transition-transform hover:scale-110" />
            ...
            <div className="space-y-3 rounded-lg border bg-card p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400">
              <Video className="h-10 w-10 text-blue-600 transition-transform hover:scale-110" />
            ...
            <div className="space-y-3 rounded-lg border bg-card p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-500">
              <FileText className="h-10 w-10 text-green-600 transition-transform hover:scale-110" />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg border p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary">
